...
class Migration(migrations.Migration):
    ...
    replaces = [('catalog', '0001_initial'), ('catalog', '0002_alter_book_id'), ('catalog', '0003_alter_book_id')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique ID for this particular book across', primary_key=True, serialize=False)),
